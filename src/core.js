...
export const FUEL_DEFINITIONS = {
  Gasolina95: {
    label: 'Gasolina 95',
    aliases: ['Gasolina95', 'Gasolina 95', 'Gasolina 95 E5', 'Precio Gasolina 95 E5', 'PrecioGasolina95']
  },
  Diesel: {
    label: 'Diésel A',
    aliases: ['Diesel', 'Diésel', 'GasoleoA', 'Gasóleo A', 'Precio Gasóleo A', 'PrecioGasoleoA']
  },
  Gasolina98: {
    label: 'Gasolina 98',
    aliases: ['Gasolina98', 'Gasolina 98', 'Gasolina 98 E5', 'Precio Gasolina 98 E5', 'PrecioGasolina98']
  },
  DieselPremium: {
    label: 'Diésel Premium',
    aliases: ['DieselPremium', 'Diésel Premium', 'GasoleoPremium', 'Gasóleo Premium', 'Precio Gasóleo Premium']
  },
  GLP: {
    label: 'GLP',
    aliases: ['GLP', 'Gases licuados del petróleo', 'Precio GLP']
  },
  DieselB: {
    label: 'Diésel B',
    aliases: ['DieselB', 'Diésel B', 'GasoleoB', 'Gasóleo B', 'Precio Gasóleo B']
  }
};
...
export function extractStationArray(payload) {
  ...
  const candidates = ['items', 'data', 'results', 'estaciones', 'stations'];
...
export function scoreStation(station, { consumption, amount, tripMode = 'roundtrip', roadFactor = ROAD_DISTANCE_FACTOR }) {
  ...
  const tripCost = tripLiters * station.price;
  const effectivePrice = amount / netLiters;
