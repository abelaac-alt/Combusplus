# Supabase para Combusplus 9.0

La instalación vigente está documentada en [docs/INSTALLATION_V9.md](docs/INSTALLATION_V9.md).

Combusplus 9 no utiliza `APP_ACCESS_TOKEN` ni `COMBUSPLUS_APP_ACCESS_TOKEN`. El acceso de usuario se basa en sesiones anónimas firmadas por instalación, límites de uso y Play Integrity para Android.
