const CACHE='combusplus-v6-0';
const SHELL=['./','./index.html','./config.js','./assets/styles.css','./assets/logo.png','./assets/icon.png','./src/app.js','./src/core.js','./manifest.webmanifest'];
