const CACHE='combusplus-v8-0';
const SHELL=['./','./index.html','./privacy.html','./config.js','./assets/styles.css','./assets/logo.png','./assets/icon-192.png','./assets/icon-512.png','./src/app.js','./src/core.js','./manifest.webmanifest'];
